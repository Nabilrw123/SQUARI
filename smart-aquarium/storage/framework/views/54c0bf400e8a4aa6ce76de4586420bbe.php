                ...
                <div class="card-body">
                    <div class="row row-cols-1 row-cols-md-3 g-3">
                        ...
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <div class="status-indicator"></div>
                                <span class="ms-2">Suhu Udara Rendah: <?php echo e($statusData['suhu_udara_min'] ?? '--'); ?>°C</span>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <div class="status-indicator"></div>
                                <span class="ms-2">Suhu Udara Tinggi: <?php echo e($statusData['suhu_udara_max'] ?? '--'); ?>°C</span>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <div class="status-indicator"></div>
                                <span class="ms-2">Suhu Air Rendah: <?php echo e($statusData['suhu_air_min'] ?? '--'); ?>°C</span>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <div class="status-indicator"></div>
                                <span class="ms-2">Suhu Air Tinggi: <?php echo e($statusData['suhu_air_max'] ?? '--'); ?>°C</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\IPB\Semester 4\WEB\project v3\smart-aquarium\resources\views/dashboard.blade.php ENDPATH**/ ?>