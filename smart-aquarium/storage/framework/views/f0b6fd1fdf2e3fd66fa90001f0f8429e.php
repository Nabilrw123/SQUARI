...
<head>
    ...
    <title><?php echo e(config('app.name', 'Smart Aquarium')); ?></title>
...
<img src="<?php echo e(asset('storage/profile/default-profile.png')); ?>" alt="Logo" style="width: 90px; height: 100px; object-fit: cover;">
        ...
        <div class="sidebar-menu mt-4">
            ...
            <a href="<?php echo e(route('sensor.data')); ?>" class="menu-item <?php echo e(request()->routeIs('sensor.data') ? 'active' : ''); ?>">
                <i class="bi bi-thermometer-half"></i>
                <span>Sensor Data</span>
            </a>
            <a href="<?php echo e(route('controls')); ?>" class="menu-item <?php echo e(request()->routeIs('controls') ? 'active' : ''); ?>">
                <i class="bi bi-toggles"></i>
                <span>Controls</span>
            </a>
            <a href="<?php echo e(route('history')); ?>" class="menu-item <?php echo e(request()->routeIs('history') ? 'active' : ''); ?>">
                <i class="bi bi-clock-history"></i>
                <span>History</span>
            </a>
            <a href="<?php echo e(route('schedules')); ?>" class="menu-item <?php echo e(request()->routeIs('schedules') ? 'active' : ''); ?>">
        ...
        <div class="mt-auto text-center p-4" style="position: absolute; bottom: 0; width: 100%;">
            <small class="text-white-50">© <?php echo e(date('Y')); ?> Smart Aquarium</small>
        </div>
    </div>
    <?php endif; ?>
    ...
    <!-- Main Content -->
    <div class="main-content <?php if(auth()->guard()->check()): ?> <?php else: ?> container <?php endif; ?>">
    ...
    <script>
        ...
        window.currentUserEmail = '<?php echo e(auth()->user()->email ?? "anonymous"); ?>';
    </script>
    ...
    // Show success message if exists
    <?php if(session('success')): ?>
        NotificationSystem.show('success', '<?php echo e(session('success')); ?>');
    <?php endif; ?>

    // Show error message if exists
    <?php if(session('error')): ?>
        NotificationSystem.show('danger', '<?php echo e(session('error')); ?>');
    <?php endif; ?>
    </script>
</body>
</html><?php /**PATH D:\IPB\Semester 4\WEB\project v3\smart-aquarium\resources\views/layouts/app.blade.php ENDPATH**/ ?>