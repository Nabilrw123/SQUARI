                    ...
                    <form action="<?php echo e(route('settings.update')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="email_notifications" name="email_notifications" value="1" <?php echo e($settings['email_notifications'] ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="email_notifications">
                                    Email Notifications
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="push_notifications" name="push_notifications" value="1" <?php echo e($settings['push_notifications'] ? 'checked' : ''); ?>>
        ...
        <div class="col-12">
            <div class="card border-danger">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('profile.destroy')); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus akun?');">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Pemrograman Web\smart-aquarium\resources\views/settings.blade.php ENDPATH**/ ?>