                        ...
                        <div class="welcome-card">
                            <div class="welcome-header">
                                ...
                                <div class="header-image">
                                    <img src="{{ asset('storage/profile/default-profile.png') }}" alt="Profile Icon" class="img-fluid" /> 
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="current-temp">
                                    <h3>Suhu Saat Ini</h3>
                                    <div class="temp-value">{{ $sensorData['suhu_ds18b20'] ? number_format($sensorData['suhu_ds18b20'], 1) : '--' }}°C</div>
                            ...
                            <div class="col-md-6">
                                <div class="current-level">
                                    ...
                                    <div class="level-gauge">
                                        <div class="gauge-value">{{ $sensorData['level_air'] ?? '--' }}%</div>
                                        <div class="gauge-bar">
                                            <div class="gauge-fill" style="height: {{ $sensorData['level_air'] ?? 0 }}%"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="current-quality">
                                    ...
                                    <div class="quality-status">
                                        <div class="status-value">{{ $sensorData['kualitas_air'] ?? 'Baik' }}</div>
                                        <div class="status-indicators">
                                            ...
                                            <div class="indicator">
                                                ...
                                                <span class="value">{{ $sensorData['tds'] ?? '--' }} ppm</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
